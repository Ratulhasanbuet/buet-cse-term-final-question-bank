  ...
  \small\begin{itemize}[leftmargin=1.2em,itemsep=1pt,label={\textcolor{cC}{$\triangleright$}}]
    ...
    \item \hyperref[sec:S6]{\textbf{S6.} MOSFET Amplifiers}
      \begin{itemize}[leftmargin=1.5em,itemsep=0pt,label={\textcolor{cC}{$\cdot$}}]
        ...
        \item \hyperref[sub:s6-rs-bias]{Source Resistor and Bias Stability}
      \end{itemize}
  \end{itemize}
\end{tcolorbox}
...
\begin{center}
       \begin{circuitikz}[thick, scale=1.2]
        ...
        % Figure Caption
        \node[below] at (0.6, -1.0) {Fig. for Q. No. 7(b)};
...
\draw (4,0) to[zzD] (4,3);    
    ...
    \draw[->, >=stealth, line width=0.8pt] (4.4, 2.2) -- (4.4, 1.4) node[midway, right] {$I_Z$};
...
\begin{center}
    ...
    \begin{tikzpicture}[thick,scale=1.2, transform shape]
        ...
        \draw (0, -2) node[ground]{} to[zD] (0, 0);
...
\begin{center}
      \begin{circuitikz}[thick,scale=1.2, transform shape]
        ...
        \draw (3,1.5) to[zD, l_={$V_Z=9.3\mathrm{V}$}] (3,3);
...
\begin{center}
      \begin{circuitikz}[thick,scale=1.2, transform shape]
        ...
        % 5. Caption Text
        \node[below] at (2.5, -0.5) {Fig. for Q. No. 1(a)};
...
\item (a) Calculate the collector current, emitter current and base current for the circuit shown in Figure . Also verify the operating mode of the transistor. Assume $\beta = 100$. (16)
...
\begin{center}
  \begin{tikzpicture}[thick,scale=1.1]
            % Transistor Core (NPN - Drawn Manually)
            \draw (2, 1) -- (2, 2); % Vertical Base line
            \draw (1, 1.5) -- (2, 1.5); % Base horizontal lead
            \draw (2, 1.7) -- (2.5, 2.2) -- (2.5, 2.5); % Collector lead
            \draw[->, >=stealth] (2, 1.3) -- (2.5, 0.8); % Emitter lead with arrow
            \draw (2.5, 0.8) -- (2.5, 0.5); % Wire to ground

            % Ground at Emitter
            \draw (2.2, 0.5) -- (2.8, 0.5);
            \draw (2.35, 0.35) -- (2.65, 0.35);
            \draw (2.45, 0.2) -- (2.55, 0.2);

            % Collector Resistor (2K Ohm Zigzag)
            \draw (2.5, 2.5) -- (2.5, 2.8);
            \draw (2.5, 2.8) -- (2.3, 2.95) -- (2.7, 3.25) -- (2.3, 3.55) -- (2.7, 3.85) -- (2.5, 4) -- (2.5, 4.3);
            \draw[->, >=stealth] (2.5, 4.3) -- (2.5, 4.8) node[above, font=\small] {5v};
            \node[right, font=\small] at (2.7, 3.4) {2K$\Omega$};

            % Base connection and 1V DC Source
            \draw (1, 1.5) -- (1, 1);
            \draw (0.6, 1) -- (1.4, 1); % Long positive plate
            \draw[line width=2pt] (0.8, 0.8) -- (1.2, 0.8); % Short negative plate
            \draw (1, 0.8) -- (1, 0.5);
            \node[right, font=\small] at (1.1, 1.2) {1v};

            % Ground at Base
            \draw (0.7, 0.5) -- (1.3, 0.5);
            \draw (0.85, 0.35) -- (1.15, 0.35);
            \draw (0.95, 0.2) -- (1.05, 0.2);

            % V_CB Arrow and Label
            \draw[<->, >=stealth] (1.3, 1.65) to[bend left=45] (2.3, 2.4);
            \node[font=\small] at (1.6, 2.15) {V$_{CB}$};

            % Path-1 Squiggly Arrow (Custom smooth path)
            \draw[->, >=stealth, gray, smooth, tension=0.7] plot coordinates {(0.3, 0.2) (0.4, 1.2) (1.2, 2.0) (1.8, 3.2) (2.1, 4.5)};
            \node[left, font=\scriptsize] at (1.8, 3.2) {path-1};

            % Caption
            \node[below] at (1.5, -0.2) {Figure-1(a)};
        \end{tikzpicture}
...
\begin{center}
        ...
        % Caption
        \node[below] at (2, -1.4) {Fig. for Q. No. 6(b)};
...
\begin{center}
          \begin{tikzpicture}[thick,scale=1.0]
            % BJT Transistor Assembly
            \draw (2,1.7) -- (2,2.5); % Base bar
            \draw (1.3,2.1) -- (2,2.1); % Base lead
            \draw (2,2.3) -- (2.5,2.8) -- (2.5,3.2); % Collector lead
            \draw[->, >=stealth] (2,1.9) -- (2.4,1.4); % Emitter arrow
            \draw (2.4,1.4) -- (2.5,1.3) -- (2.5,1.0); % Emitter lead
            
            % Collector Branch (Resistor to VCC)
            % Resistor Zigzag
            \draw (2.5,3.2) -- (2.5,3.4) -- (2.35,3.5) -- (2.65,3.65) -- (2.35,3.8) -- (2.65,3.95) -- (2.35,4.1) -- (2.5,4.2) -- (2.5,4.4);
            \draw[->, >=stealth] (2.5,4.4) -- (2.5,4.8) node[above] {15v};
            
            % Output Node Vo
            \draw (2.5,3.2) -- (3.0,3.2) node[circle, fill, inner sep=1pt] {} node[right] {$V_o$};
            
            % Emitter Branch (RE to Ground)
            % RE Resistor Zigzag
            \draw (2.5,1.0) -- (2.5,0.8) -- (2.35,0.7) -- (2.65,0.55) -- (2.35,0.4) -- (2.65,0.25) -- (2.35,0.1) -- (2.5,0) -- (2.5,-0.2);
            \node[right] at (2.65,0.4) {$R_E$};
            
            % Emitter Ground
            \draw (2.2,-0.2) -- (2.8,-0.2);
            \draw (2.35,-0.3) -- (2.65,-0.3);
            \draw (2.45,-0.4) -- (2.55,-0.4);
            
            % Base Branch (Battery VB to Ground)
            \draw (1.3,2.1) -- (0.8,2.1) -- (0.8,1.2);
            % Battery symbol
            \draw (0.5,1.2) -- (1.1,1.2); % Positive plate
            \draw[line width=2pt] (0.65,1.0) -- (0.95,1.0); % Negative plate
            \draw (0.8,1.0) -- (0.8,0.6);
            \node[left=0.1cm] at (0.5,1.1) {$V_B$};
            
            % Base Ground
            \draw (0.5,0.6) -- (1.1,0.6);
            \draw (0.65,0.5) -- (0.95,0.5);
            \draw (0.75,0.4) -- (0.85,0.4);
...
\begin{center}
      \begin{circuitikz}[thick,scale=1.2, transform shape]
        ...
        \draw[->, >=stealth] (2.6, 1.0) -- (2.6, 0.3) node[midway, right] {$i_{DN}$};
        % আউটপুট জাংশন থেকে QP-এর সোর্সের দিকে i_DP
        \draw[->, >=stealth] (2.6, -0.3) -- (2.6, -1.0) node[midway, right] {$i_{DP}$};
...
\begin{center}
    ...
    \begin{tikzpicture}[scale=1.1, transform shape, thick]
        ...
        \node[left=0.1cm] at (pA.G) {\textsf{A}};
        
        % PMOS D (Top Right)
        \node[pmos] (pD) at (2, 3.5) {};
        \node[left=0.1cm] at (pD.G) {\textsf{D}};
        
        % PMOS B & C (Middle Parallel Pair)
        \node[pmos] (pB) at (-1.5, 1.5) {};
        \node[left=0.1cm] at (pB.G) {\textsf{B}};
        
        \node[pmos] (pC) at (0.5, 1.5) {};
        \node[left=0.1cm] at (pC.G) {\textsf{C}};
        ...
        \draw (0.5, 0) -- (3, 0) node[ocirc] {} node[right] {\textsf{Y}};
        ...
        \node[left=0.1cm] at (nA.G) {\textsf{A}};
        
        % NMOS B & C Stack (Right branch)
        \node[nmos] (nB) at (1.5, -1.5) {};
        \node[left=0.1cm] at (nB.G) {\textsf{B}};
        
        \node[nmos] (nC) at (1.5, -3.0) {};
        \node[left=0.1cm] at (nC.G) {\textsf{C}};
        
        % NMOS D (Bottom)
        \node[nmos] (nD) at (1.5, -4.5) {};
        \node[left=0.1cm] at (nD.G) {\textsf{D}};
        ...
        % Ground Connection
        \draw (nD.S) -- (1.5, -5.2) node[ground] {} node[right=0.2cm] {\textsf{GND}};
...
\begin{tikzpicture}[american, line width=0.8pt]
    ...
    % GLOBAL CAPTION
    % =========================================================================
    \node[font=\bfseries] at (5.0, -2.8) {Fig. 1(b)};
...
\begin{center}
      \begin{circuitikz}[thick,scale=1.2, transform shape]
        ...
        \draw (C_node) to[R, l={$R_C = 5\text{ k}\Omega$}] (0, -3.5);
...
\begin{center}
    ...
    \begin{circuitikz}[thick,scale=0.9, transform shape]
        ...
        % Caption
        % ==========================================
        \node at (8, -2) {\Large Fig. for Q. 8(a)};
...
\begin{circuitikz}[american, line width=0.8pt]
    ...
    \draw[-latex, line width=1pt] (2.5, 4.2) -- (2.5, 5.0) node[above] {\textbf{+9 V}};
    ...
    % --- Caption ---
    \node at (3.5, -2.5) {Fig. for Q. No. 5(a)};
...
\begin{circuitikz}[thick,american, scale=1.2]
    ...
    % 6. Figure Caption
    \node[below, font=\large] at (-0.5,-2.8) {Fig. for Q3(a)};
...
\begin{center}
      \begin{circuitikz}[thick,scale=1.2, transform shape]
        ...
        \draw[-latex] (-5, -2.2) -- (-5, -1.1) -- (-4.2, -1.1);
...
\begin{center}
 ...
 \begin{circuitikz}[thick,american, scale=1.1]
        ...
        \draw (Vin_gnd.center) node[ground] {} node[above=2pt] {$-$};
...
\begin{center}
    ...
    \begin{tikzpicture}[thick,x=1.5cm, y=1cm, font=\sffamily]
        ...
        \node[below] at (0, -2.8) {Fig. for Q No. 2(b)};
...
\begin{center}
    \begin{tikzpicture}[thick,scale=1.2, font=\sffamily]

    % ==========================================
    % Top Plot: Output Wave Shape
    % ==========================================
...
\begin{tikzpicture}[scale=1.0]
    ...
    % GLOBAL CAPTION
    % ==========================================
    \node[font=\bfseries] at (5.0, -1.8) {Fig. for Q. No. 5(c)};
...
\begin{center}
    ...
    \begin{tikzpicture}[thick,x=0.8cm, font=\sffamily]
        ...
        % Caption
        \node[below] at (6, -2.5) {Fig for Q. No. 2(c)};
...
\begin{center}
    ...
    \begin{circuitikz}[thick,scale=0.85, transform shape]
        % Define common ground line
        \draw (0,-3.5) coordinate (gnd_left) -- (15,-3.5) coordinate (gnd_right);
        \draw (7.5,-3.5) node[ground] {};
        
        % ================= Op-amp 1 =================
        \draw (2,0) node[op amp] (op1) {};
        \draw (op1.up) -- ++(0,0.4) node[above] {$+15$ V};
        \draw (op1.down) -- ++(0,-0.4) node[below] {$-15$ V};
        \draw (op1.+) -- (op1.+ |- 0,-3.5); % Ground positive input
        
        % Op1 Feedback (Rf)
        \draw (op1.-) -- ++(0,1.2) coordinate (rf_left)
              to[R, l=$R_f$] (rf_left -| op1.out)
              -- (op1.out);
              
        % Op1 Input (Ri)
        \draw (op1.-) -- ++(-1,0) coordinate (in1_node)
              to[R, l_=$R_i$] ++(-2,0) coordinate (global_in);
              
        % V0 Output label
        \node[below right] at (op1.out) {$V_0$};
        \node[above right] at (op1.out) {$+$};
        \node[above right] at (op1.out |- 0,-3.5) {$-$};
        
        % RC Stage 1
        \draw (op1.out) to[R, l=$R$, *-] ++(2.2,0) coordinate (rc1_node);
        \draw (rc1_node) to[C, l_=$C$, *-*] (rc1_node |- 0,-3.5);
        
        % ================= Op-amp 2 =================
        \draw (6.5,0) node[op amp] (op2) {};
        \draw (op2.up) -- ++(0,0.4) node[above] {$+15$ V};
        \draw (op2.down) -- ++(0,-0.4) node[below] {$-15$ V};
        \draw (rc1_node) -- (op2.+);
        
        % Buffer feedback Op2
        \draw (op2.-) -- ++(0,1) coordinate (buf1_top)
              -- (buf1_top -| op2.out)
              -- (op2.out);
              
        % RC Stage 2
        \draw (op2.out) to[R, l=$R$, *-] ++(2.2,0) coordinate (rc2_node);
        \draw (rc2_node) to[C, l_=$C$, *-*] (rc2_node |- 0,-3.5);
        
        % ================= Op-amp 3 =================
        \draw (11,0) node[op amp] (op3) {};
        \draw (op3.up) -- ++(0,0.4) node[above] {$+15$ V};
        \draw (op3.down) -- ++(0,-0.4) node[below] {$-15$ V};
        \draw (rc2_node) -- (op3.+);
        
        % Buffer feedback Op3
        \draw (op3.-) -- ++(0,1) coordinate (buf2_top)
              -- (buf2_top -| op3.out)
              -- (op3.out);
              
        % RC Stage 3
        \draw (op3.out) to[R, l=$R$, *-] ++(2.5,0) coordinate (rc3_node);
        \draw (rc3_node) to[C, l_=$C$, *-*] (rc3_node |- 0,-3.5);
        
        % Vf Output label
        \node[right] at (rc3_node) {$+$};
        \node[right] at (rc3_node |- 0,-3.5) {$-$};
        \node[above right] at (rc3_node |- 0,-1.5) {$V_f$};
        
        % ================= Global Feedback =================
        \draw (rc3_node) -- ++(1,0) coordinate (fb_start)
              -- ++(0, 3) coordinate (fb_top_right)
              -- (fb_top_right -| global_in) coordinate (fb_top_left)
              -- (global_in);
...
\begin{center}
    ...
    \begin{circuitikz}[thick,scale=1, transform shape]
        ...
        % Vertical R1
        \draw (node1) to[R, l=$R_1$, *-*] (node1 |- gnd_line_left);
...
\begin{center}
    ...
    % Figure Caption
    % ==========================================
    \node[below, font=\large] at (0.5, -1.8) {Fig. for Q. No. 8(a)};
