...
\begin{tcolorbox}[breakable,colback=cA!5,colframe=cA,boxrule=1pt,arc=5pt,
  ...
  {\large\bfseries\textcolor{cA}{Part I --- Vector Calculus}}\par\vspace{5pt}
  \textcolor{cA!40}{\rule{\linewidth}{0.4pt}}\par\vspace{3pt}
...
\begin{tcolorbox}[breakable,colback=cB!5,colframe=cB,boxrule=1pt,arc=5pt,
  left=8pt,right=8pt,top=8pt,bottom=8pt,before skip=4pt]
  {\large\bfseries\textcolor{cB}{Part II --- Complex Calculus}}\par\vspace{5pt}
  \textcolor{cB!40}{\rule{\linewidth}{0.4pt}}\par\vspace{3pt}
  \small\begin{itemize}[leftmargin=1.2em,itemsep=1pt,label={\textcolor{cB}{$\triangleright$}}]
    \item \hyperref[sec:S5]{\textbf{S2.} Complex Calculus}
      \begin{itemize}[leftmargin=1.5em,itemsep=0pt,label={\textcolor{cB}{$\cdot$}}]
        \item \hyperref[sub:s5-geometry]{Roots \& Geometry of Complex Numbers}
...
\begin{tcolorbox}[breakable,colback=cC!5,colframe=cC,boxrule=1pt,arc=5pt,
  left=8pt,right=8pt,top=8pt,bottom=8pt,before skip=4pt]
  {\large\bfseries\textcolor{cC}{Part III --- Partial Differential Equations}}\par\vspace{5pt}
  \textcolor{cC!40}{\rule{\linewidth}{0.4pt}}\par\vspace{3pt}
  \small\begin{itemize}[leftmargin=1.2em,itemsep=1pt,label={\textcolor{cC}{$\triangleright$}}]
    \item \hyperref[sec:S6]{\textbf{S3.} Partial Differential Equations}
      \begin{itemize}[leftmargin=1.5em,itemsep=0pt,label={\textcolor{cC}{$\cdot$}}]
        ...
        \item \hyperref[sub:s6-first]{First Order Linear PDE}
        \item \hyperref[sub:s6-firstNon]{First Order Non-linear PDE}
        \item \hyperref[sub:s6-second]{Second Order Linear PDE: Classifications}
        \item \hyperref[sub:s6-hhigher]{Homogenous linear PDE with constant coefficients}
        \item \hyperref[sub:s6-Nhhigher]{Non-homogeneous linear PDE with constant coefficients}
        \item \hyperref[sub:s6-euler]{Euler-Cauchy type PDE}
...
%% ══════════════════════════════════════════════════════════════════════
\secdivider{Vector Calculus}{Vector Algebra, Gradient, Divergence, Curl, Integration Theorems}{cA}

\section{S1. Vector Calculus}
\label{sec:S4}
\markboth{S1. Vector Calculus}{}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Vector Algebra}
...
\end{enumerate}
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Differentiation and Integration of Vectors}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Gradient and Directional Derivative}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Divergence and Curl}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Vector Calculus Identities: Jacobian, Hessian, Laplacian}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Surface Integrals \& Divergence Theorem}
...
%% ══════════════════════════════════════════════════════════════════════
\secdivider{Complex Calculus}{Analytic Functions, Cauchy-Riemann, Complex Integration}{cB}


\section{S2. Complex Calculus}
\label{sec:S5}
\markboth{S2. Complex Calculus}{}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Roots \& Geometry of Complex Numbers}
...
\mk{10} \yr{MATH 241 | L-2/T-1 | 2015--16, 2014--15}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Limits and Continuity of Complex Functions}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Analytic Functions \& Cauchy-Riemann Equations}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Elementary Complex Functions}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Line Integral of Complex Functions}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Cauchy's Integral Formula \& Theorem}
\label{sub:s5-cauchy}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Residues \& Residue Theorem}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Contour Integration}
...
%% ══════════════════════════════════════════════════════════════════════
\secdivider{Partial Differential Equations}{Formation, First \& Second Order PDE, Separation of Variables}{cC}

\section{S3. Partial Differential Equations}
\label{sec:S6}
\markboth{S3. Partial Differential Equations}{}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Introduction \& Formation of PDE}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{First Order Linear PDE}
\label{sub:s6-first}
...
\subtopic{cC}{First Order Non-linear PDE}
\label{sub:s6-firstNon}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Second Order Linear PDE: Classifications}
\label{sub:s6-second}
...
\subtopic{cC}{Homogenous linear PDE with constant coefficients}
\label{sub:s6-hhigher}
...
\item Solve the following homogeneous partial differential equation: $(D_{x}^{2}-2D_{x}D_{y})z=4e^{2x}+5x^{2}y$ \mk{13}

\yr{MATH 147 | L-1/T-2 | 2020--21}

\item Solve the following:
 $(D_{x}^{2}+4D_{x}D_{y}+4D_{y}^{2})z=e^{2x+y}$ \mk{13}
\yr{MATH 147 | L-1/T-2 | 2017--18}

\item Solve the following equations: $(D_{x}^{2}-D_{x}D_{y}-2D_{y}^{2})z=(y-1)e^{x}$ \mk{15} \yr{MATH 143 | L-1/T-2 | 2014--15} \yr{MATH 147 | L-1/T-2 | 2016--17}


\item Solve the homogeneous equation: $(D_{x}^2+D_{x}D_{y}-2D_{y}^2)z=(2x+y)^{1/2}+e^{y+2x}.$
\mk{15} \yr{MATH 147 | L-1/T-2 | 2015--16}
...
\subtopic{cC}{Non-homogeneous linear PDE with constant coefficients}
\label{sub:s6-Nhhigher}
...
\item Solve the following non-homogeneous partial differential equation:
\begin{enumerate}
...
\subtopic{cC}{Euler-Cauchy type PDE}
\label{sub:s6-euler}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Solution by Separation of Variables}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Boundary Value Problems}
\label{sub:s6-bvp}
