...
% Add section entries to the .toc without creating a second PDF bookmark.
\makeatletter
\newcommand{\addsectiontoc}[1]{%
  \addtocontents{toc}{%
    \protect\contentsline{section}{#1}{\thepage}{\@currentHref}\protected@file@percent
  }%
}
\makeatother
...
(MOSFETs)}}\\[5pt]
  ...
  \small\begin{itemize}[leftmargin=1.2em,itemsep=1pt,label={\textcolor{cB}{$\triangleright$}}]
      ...
      \begin{itemize}[leftmargin=1.5em,itemsep=0pt,label={\textcolor{cA}{$\cdot$}}]
        ...
        \item \hyperref[sub:s5-cmos-inverter]{CMOS Inverter Analysis}
...
\phantomsection
\pdfbookmark[1]{S1: Diode Characteristics}{sec:S1}
\label{sec:S1}
\titleformat{\section}{\large\bfseries\color{cA}}{}{0em}{}[\titlerule]
\section*{S1 \quad Diode Characteristics}
\addsectiontoc{S1: Diode Characteristics}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Diode Circuit Analysis}{sub:s1-dc}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Diode Models (Ideal, CVD, Piecewise Linear)}{sub:s1-models}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Small Signal Model}{sub:s1-ssm}
...
(iii) find the value of $I$ that will provide a phase shift of $-45^\circ$; \\
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Peak Rectifier}{sub:s1-peak}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{I-V Characteristics \& Waveform Analysis}{sub:s1-iv}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Diode Thermal Characteristics}{sub:s1-thermal}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Bridge Rectifier}{sub:s1-rectifier}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Zener Diode Regulator}{sub:s1-zener}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Battery Charger Circuit}{sub:s1-battery}
...
\subtopic{cA}{Special Purpose Diodes/Thyristors}{sub:s1-spd}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Miscellaneous}{sub:s1-Miscellaneous}
...
\phantomsection
\pdfbookmark[1]{S2: Clipping, Clamping Circuits}{sec:S2}
\label{sec:S2}
\titleformat{\section}{\large\bfseries\color{cA}}{}{0em}{}[\titlerule]
\section*{S2 \quad Clipping, Clamping Circuits}
\addsectiontoc{S2: Clipping, Clamping Circuits}


%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Clipping Circuits --- Waveform \& Transfer Characteristics}{sub:s2-clipping}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Clamping Circuits}{sub:s2-clamping}
...
\phantomsection
\pdfbookmark[1]{S3: BJT Characteristics}{sec:S3}
\label{sec:S3}


\section*{S3 \quad BJT Characteristics}
\addsectiontoc{S3: BJT Characteristics}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Energy Band Profile}{sub:s3-energy}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Device Structure and Operating Principle}{sub:s3-structure}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Early Effect}{sub:s3-early}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{DC Analysis}{sub:s3-dc}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{BJT Saturation Parameters}{sub:s3-saturation}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Multi-BJT Circuit Analysis}{sub:s3-multibjtdc}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Voltage Transfer Characteristics}{sub:s3-vtc}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Operating Mode Design}{sub:s3-opmode}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Biasing and Stability}{sub:s3-biasing}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{BJT Circuit Design}{sub:s3-design}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Linear Amplifier Constraints}{sub:s3-linear}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Switching Circuits --- Logic Gates using BJTs}{sub:s3-switching}
...
%%─────────────────────────────────────────────────────────────────────
\subtopic{cC}{BJT Inverter Analysis}{sub:s3-inverter}
...
\phantomsection
\pdfbookmark[1]{S4: BJT Amplifiers}{sec:S4}
\label{sec:S4}
\titleformat{\section}{\large\bfseries\color{cC}}{}{0em}{}[\titlerule]


\section*{S4 \quad BJT Amplifiers}
\addsectiontoc{S4: BJT Amplifiers}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Common Emitter / Trans-conductance Amplifier}{sub:s4-ce}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Common Base Amplifier}{sub:s4-cb}
...
\subtopic{cC}{Bootstrapped Follower}{sub:s4-bootstrap}
...
\subtopic{cC}{Common Collector (Emitter Follower)}{sub:s4-cc}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Biasing and Input Impedance}{sub:s4-biasimpedance}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{BJT Input-Output Characteristics}{sub:s4-io}
...
\phantomsection
\pdfbookmark[1]{S5: MOSFET Characteristics}{sec:S5}
\label{sec:S5}

\section*{S5 \quad MOSFET Characteristics}
\addsectiontoc{S5: MOSFET Characteristics}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Device Characteristics}{sub:s5-devchar}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Comparison with BJT}{sub:s5-compare}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Threshold Voltage}{sub:s5-threshold}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{DC Analysis \& Transistor Sizing}{sub:s5-dc}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Multi-stage MOSFET Circuit Design}{sub:s5-multistage}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{MOSFET Transconductance}{sub:s5-gm}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Voltage Transfer Characteristics}{sub:s5-vtc}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{MOSFET as Small-Signal Amplifier}{sub:s5-ssa}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Biasing Stability}{sub:s5-biasing}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{CMOS Logic Implementation}{sub:s5-cmos}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{CMOS Sizing and Delay}{sub:s5-sizing}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{NMOS Circuit Design}{sub:s5-nmos}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{CMOS Inverter Analysis}{sub:s5-cmos-inverter}
...
\phantomsection
\pdfbookmark[1]{S6: MOSFET Amplifiers}{sec:S6}
\label{sec:S6}

\section*{S6 \quad MOSFET Amplifiers}
\addsectiontoc{S6: MOSFET Amplifiers}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Common Gate Amplifier}{sub:s6-cg}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Common Source Amplifier}{sub:s6-cs}
...
\phantomsection
\pdfbookmark[1]{S7: Operational Amplifiers (Op-Amps)}{sec:S7}
\label{sec:S7}
\titleformat{\section}{\large\bfseries\color{cE}}{}{0em}{}[\titlerule]


\section*{S7 \quad Operational Amplifiers (Op-Amps)}
\addsectiontoc{S7: Operational Amplifiers}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Ideal Op-Amp Characteristics}{sub:s7-ideal}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Mathematical Operations}{sub:s7-math}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Logarithmic / Exponential Amplifier}{sub:s7-log}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Difference Amplifier}{sub:s7-diff}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Comparator and Schmitt Trigger}{sub:s7-schmitt}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Waveform Generation}{sub:s7-wave}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Analog Computing (Differential Equations)}{sub:s7-analog}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Multiplier Circuit Design}{sub:s7-mult}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Frequency Multiplier}{sub:s7-freqmult}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Active Filters}{sub:s7-filters}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Voltage-to-Current Converter}{sub:s7-v2i}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{System Design (Analog to Digital Interface)}{sub:s7-sysdesign}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Waveform Realization}{sub:s7-wavereal}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Integrator}{sub:s7-integrator}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Op-Amp Network Analysis}{sub:s7-network}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Op-Amp Practical Imperfections}{sub:s7-imperfections}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Dual Slope A/D Converter}{sub:s7-adc}
...
\phantomsection
\pdfbookmark[1]{S8: Oscillators, Timers \& Function Generators}{sec:S8}
\label{sec:S8}
\titleformat{\section}{\large\bfseries\color{cF}}{}{0em}{}[\titlerule]


\section*{S8 \quad Oscillators, Timers \& Function Generators}
\addsectiontoc{S8: Oscillators, Timers \& Function Generators}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{Barkhausen Stability Criterion}{sub:s8-barkhausen}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{Wien Bridge Oscillator}{sub:s8-wien}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{RC Phase Shift Oscillator}{sub:s8-rcphase}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{LC Oscillator}{sub:s8-lc}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{Colpitts Oscillator}{sub:s8-colpitts}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{Crystal Oscillator}{sub:s8-crystal}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{One-Shot (Monostable) Multivibrator}{sub:s8-oneshot}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{555 Timer --- Oscillator Design}{sub:s8-555}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{Triangular Wave Generator}{sub:s8-triangular}
...
\phantomsection
\pdfbookmark[1]{S9: Digital Logic \& Sequential Circuits}{sec:S9}
\label{sec:S9}
\titleformat{\section}{\large\bfseries\color{cD}}{}{0em}{}[\titlerule]

\section*{S9 \quad Digital Logic \& Sequential Circuits}
\addsectiontoc{S9: Digital Logic \& Sequential Circuits}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{CMOS Logic Design and Implementation}{sub:s9-cmos}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{CMOS Transistor Sizing}{sub:s9-sizing}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Inverter Propagation Delay}{sub:s9-delay}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Transmission Gate Implementation}{sub:s9-tg}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{CMOS Flip-Flop Implementation}{sub:s9-ff-cmos}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Flip-Flop Construction}{sub:s9-ff-construction}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Counter Design}{sub:s9-counter}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Combinational Logic Design}{sub:s9-combo}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Priority Encoder}{sub:s9-encoder}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Shift Register Design}{sub:s9-shift}
...
\phantomsection
\pdfbookmark[1]{S10: Data Converters, PLL \& Memory}{sec:S10}
\label{sec:S10}
\titleformat{\section}{\large\bfseries\color{cG}}{}{0em}{}[\titlerule]

\section*{S10 \quad Data Converters, PLL \& Memory}
\addsectiontoc{S10: Data Converters, PLL \& Memory}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cG}{Digital-to-Analog Converter (DAC)}{sub:s10-dac}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cG}{Analog-to-Digital Converter (ADC)}{sub:s10-adc}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cG}{Phase-Locked Loop (PLL)}{sub:s10-pll}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cG}{Memory: DRAM and Flash}{sub:s10-memory}
