...
\DeclareFontShape{T1}{cmss}{bx}{it}{<->ssub*cmss/bx/sl}{}
...
\tcbset{
  ansbox/.style={enlarge left by=-\leftmargin, width=\linewidth+\leftmargin},
  before upper={\hfuzz=100pt}
}

% Narrow tables and long schema identifiers are intentional in this handout.
\hbadness=10000
\hfuzz=100pt
\tracinglostchars=0
...
\pdfbookmark[1]{S1: Database Fundamentals}{sec:S1}
\label{sec:S1}
\markboth{S1 --- Database Fundamentals}{}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Concepts of Database Systems}{sub:s1-concepts}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Relational Model}{sub:s1-relational}
...
\pdfbookmark[1]{S2: Database Design}{sec:S2}
\label{sec:S2}
\markboth{S2 --- Database Design}{}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Entity-Relationship (ER) Model}{sub:s2-er}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{ER Diagrams}{sub:s2-erdiag}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Database Schema Design}{sub:s2-schema}
...
\pdfbookmark[1]{S3: Query Languages}{sec:S3}
\label{sec:S3}
\markboth{S3 --- Query Languages}{}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{SQL}{sub:s3-sql}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Relational Algebra}{sub:s3-relalg}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Joins}{sub:s3-joins}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Constraints, Assertions \& Triggers}{sub:s3-constraints}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Functions and Procedures}{sub:s3-funcs}
...
\pdfbookmark[1]{S4: Normalization}{sec:S4}
\label{sec:S4}
\markboth{S4 --- Normalization}{}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Functional Dependencies}{sub:s4-fd}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Normal Forms (BCNF, 3NF, 4NF)}{sub:s4-nf}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Anomalies \& Normalization}{sub:s4-anomaly}
...
\pdfbookmark[1]{S5: Storage and Indexing}{sec:S5}
\label{sec:S5}
\markboth{S5 --- Storage and Indexing}{}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Data Storage Architecture \& RAID}{sub:s5-storage}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Primary Index}{sub:s5-primary}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Secondary \& Bitmap Index}{sub:s5-secondary}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{\texorpdfstring{B\textsuperscript{+} Tree Index}{B+ Tree Index}}{sub:s5-btree}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Hash Index}{sub:s5-hash}
...
\pdfbookmark[1]{S6: Query Processing}{sec:S6}
\label{sec:S6}
\markboth{S6 --- Query Processing}{}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Query Processing}{sub:s6-qp}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Query Optimization}{sub:s6-qo}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Joins}{sub:s6-joins}
...
\pdfbookmark[1]{S7: Transaction Management}{sec:S7}
\label{sec:S7}
\markboth{S7 --- Transaction Management}{}

\subtopic{cE}{Transactions \& ACID Properties}{sub:s7-acid}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Concurrency Control}{sub:s7-cc}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Deadlock}{sub:s7-deadlock}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Recovery Systems}{sub:s7-recovery}
...
\pdfbookmark[1]{S8: Advanced Topics}{sec:S8}
\label{sec:S8}
\markboth{S8 --- Advanced Topics}{}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Distributed \& Parallel Databases}{sub:s8-dist}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Big Data \& XML}{sub:s8-bigdata}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Table Partitioning}{sub:s8-partition}
