...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Concepts of Database Systems}\label{sub:s1-concepts}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Relational Model}\label{sub:s1-relational}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Entity-Relationship (ER) Model}\label{sub:s2-er}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{ER Diagrams}\label{sub:s2-erdiag}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Database Schema Design}\label{sub:s2-schema}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{SQL}\label{sub:s3-sql}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Relational Algebra}\label{sub:s3-relalg}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Joins}\label{sub:s3-joins}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Constraints, Assertions \& Triggers}\label{sub:s3-constraints}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Functions and Procedures}\label{sub:s3-funcs}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Functional Dependencies}\label{sub:s4-fd}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Normal Forms (BCNF, 3NF, 4NF)}\label{sub:s4-nf}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Anomalies \& Normalization}\label{sub:s4-anomaly}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Data Storage Architecture \& RAID}\label{sub:s5-storage}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Primary Index}\label{sub:s5-primary}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Secondary \& Bitmap Index}\label{sub:s5-secondary}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{\texorpdfstring{B\textsuperscript{+} Tree Index}{B+ Tree Index}}\label{sub:s5-btree}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Hash Index}\label{sub:s5-hash}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Query Processing}\label{sub:s6-qp}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Query Optimization}\label{sub:s6-qo}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Joins}\label{sub:s6-joins}
...
\subtopic{cE}{Transactions \& ACID Properties}\label{sub:s7-acid}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Concurrency Control}\label{sub:s7-cc}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Deadlock}\label{sub:s7-deadlock}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Recovery Systems}\label{sub:s7-recovery}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Distributed \& Parallel Databases}\label{sub:s8-dist}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Big Data \& XML}\label{sub:s8-bigdata}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Table Partitioning}\label{sub:s8-partition}
