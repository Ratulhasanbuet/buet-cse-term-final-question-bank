...
\begin{tcolorbox}[breakable,colback=cB!5,colframe=cB,boxrule=1pt,arc=5pt,
  left=8pt,right=8pt,top=8pt,bottom=8pt,before skip=4pt]
  {\large\bfseries\textcolor{cB}{Part II --- Combinational Logic}}\\[5pt]
...
\begin{tcolorbox}[breakable,colback=cC!5,colframe=cC,boxrule=1pt,arc=5pt,
  left=8pt,right=8pt,top=8pt,bottom=8pt,before skip=4pt]
  {\large\bfseries\textcolor{cC}{Part III --- Sequential Logic Design}}\\[5pt]
...
\begin{tcolorbox}[breakable,colback=cG!5,colframe=cG,boxrule=1pt,arc=5pt,
  ...
  \small\begin{itemize}[leftmargin=1.2em,itemsep=1pt,label={\textcolor{cG}{$\triangleright$}}]
    ...
    \item \hyperref[sec:S8]{\textbf{S8.} Memory \& Programmable Logic (RAM, ROM, PLA)}
      \begin{itemize}[leftmargin=1.5em,itemsep=0pt,label={\textcolor{cG}{$\cdot$}}]
        \item \hyperref[sub:s8-rom]{RAM / ROM Design \& Expansion}
...
\draw[thick] (7.2, 1.5) -- (7.2, 0.5) -- (4.2, -0.2) |- (N6.in 1);

% Q' Feedback to N5
\fill (7.2, -1.5) circle (2pt);
\draw[thick] (7.2, -1.5) -- (7.2, -0.5) -- (4.2, 0.2) |- (N5.in 2);
...
\fill (1.2, 1.78) circle (2pt); % Connection dot for N2 feedback

% R Line (N3 out to N6 in)
\draw[thick] (N3.out) -- (N6.in 2) node[midway, above] {$R$};
\fill (1.2, -1.78) circle (2pt); % Connection dot for N3 feedback
...
\draw[thick] (N1.out) -- (1.2, 4.0) -- (1.2, 3.2) -- (-1.5, 2.7) |- (N2.in 1);

% N2 Output to N1 Bottom Input
\draw[thick] (1.2, 1.78) -- (1.2, 2.5) -- (-1.6, 3) |- (N1.in 2);
...
\begin{center}
      \begin{circuitikz}[thick, scale=0.9, transform shape]
        ...
        \draw (6, 1.4) |- (OR1.in 2) ++(-0.1,0) circle (0.05);
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cH}{RAM \& ROM Design \& Expansion}
\label{sub:s8-rom}
