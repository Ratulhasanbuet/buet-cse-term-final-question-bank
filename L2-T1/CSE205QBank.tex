...
% The compact contents panels and long exam prompts intentionally use tight
% line boxes; avoid non-actionable bad-box diagnostics in the build log.
\hbadness=10000
\hfuzz=40pt
...
\newcommand{\addsectiontoc}[1]{%
  \begingroup
    \hypersetup{bookmarksdepth=0}% Keep the TOC entry without a duplicate outline item.
  ...
  \small\begin{itemize}[leftmargin=1.2em,itemsep=1pt,label={\textcolor{cD}{$\triangleright$}}]
    \item \hyperref[sec:S4]{\textbf{S4.} Arithmetic \& Data Handling Circuits, Decoders, Encoders, MUX/DEMUX}
      \begin{itemize}[leftmargin=1.5em,itemsep=0pt,label={\textcolor{cD}{$\cdot$}}]
        ...
        \item \hyperref[sub:s4-code-converter]{Code Converter}
        ...
        \item \hyperref[sub:s4-encoders]{Encoders}
        \item \hyperref[sub:s4-decoder-func]{Decoders}
  ...
  \small\begin{itemize}[leftmargin=1.2em,itemsep=1pt,label={\textcolor{cG}{$\triangleright$}}]
    ...
    \item \hyperref[sec:S8]{\textbf{S8.} Memory \& Programmable Logic (RAM, ROM, PLA)}
      \begin{itemize}[leftmargin=1.5em,itemsep=0pt,label={\textcolor{cG}{$\cdot$}}]
        ...
        \item \hyperref[sub:s8-ram]{RAM Design}
        \item \hyperref[sub:s6-sync-design]{Synchronous Sequential Circuit Design}
      \end{itemize}
  \end{itemize}
\end{tcolorbox}
...
\phantomsection
\label{sec:S1}
\pdfbookmark[1]{S1: Boolean Algebra, Theorems \& Logic Gates}{sec:S1}
\section*{S1 \quad Boolean Algebra, Theorems \& Logic Gates}
\addsectiontoc{S1: Boolean Algebra, Theorems \& Logic Gates}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Boolean Algebra \& Simplification}{sub:s1-bool-algebra}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{De Morgan's Theorem}{sub:s1-demorgan}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Logic Gates, Universal Gates \& Definitions}{sub:s1-logic-gates}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Circuit Analysis}{sub:s1-circuit-analysis}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Two-Level \& Multi-Level Logic Implementation}{sub:s1-two-level}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{NOR Gate Implementation}{sub:s1-nor-impl}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{XOR Properties}{sub:s1-xor}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cA}{Parity Checker and Generator}{sub:s1-parity}
...
\phantomsection
\label{sec:S2}
\pdfbookmark[1]{S2: Canonical Forms \& Boolean Functions}{sec:S2}
\section*{S2 \quad Canonical Forms \& Boolean Functions}
\addsectiontoc{S2: Canonical Forms \& Boolean Functions}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cB}{Canonical vs Standard Forms}{sub:s2-canonical}
...
\subtopic{cB}{Minterms, Maxterms}{sub:s2-Min-Maxterms}
\begin{enumerate}
...
\phantomsection
\label{sec:S3}
\pdfbookmark[1]{S3: Minimization Techniques}{sec:S3}
\section*{S3 \quad Minimization Techniques}
\addsectiontoc{S3: Minimization Techniques}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Prime Implicants}{sub:s3-prime-implicants}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Karnaugh Map}{sub:s3-kmap}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cC}{Tabulation Method (Quine-McCluskey)}{sub:s3-tabulation}
...
\phantomsection
\label{sec:S4}
\pdfbookmark[1]{S4: Combinational Logic}{sec:S4}
\section*{S4 \quad Combinational Logic}
\addsectiontoc{S4: Combinational Logic}

\subtopic{cD}{Number System \& Arithmetic Operations}{sub:s4-number-sys}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Code Converter}{sub:s4-code-converter}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Binary Adder \& Subtractor}{sub:s4-adder-sub}
...
\item Using 4-bit binary adder and XOR gate, design a circuit which takes two 4-bit BCD inputs $A$ and $B$, and returns $A+1$ if the control input is $00$, $A'$ if the control input is $01$, $A'+1$ when the control input is $10$, and $A$ when the control input is $11$.\mk{13}
\yr{CSE 205 | L-2/T-1 | 2018--19}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{BCD Adder-Subtractor}{sub:s4-bcd-addsub}

\begin{enumerate}


\item Design a BCD adder-subtractor which takes two 4-bit BCD numbers $A$ and $B$. Addition and subtraction is selected by a selector bit $S$: when $S=0$ the circuit produces $A+B$; when $S=1$ it produces $A-B$. Explain the operations $9+7$ and $9-7$ with your designed circuit.
\mk{12} \yr{CSE 205 | L-2/T-1 | 2020--21, 2017--18, 2016--17}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Carry Look-Ahead Adder (CLA)}{sub:s4-cla}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{2's Complement Circuit}{sub:s4-2scomp}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Overflow Detection}{sub:s4-overflow}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Binary Multiplier}{sub:s4-multiplier}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Incrementer}{sub:s4-incrementer}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Magnitude Comparator}{sub:s4-comparator}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Encoders}{sub:s4-encoders}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Decoders}{sub:s4-decoder-func}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Decoder as Demultiplexer}{sub:s4-demux}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{BCD to 7-Segment Decoder \& BCD Error Detector}{sub:s4-bcd}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Multiplexers \& Demultiplexers}{sub:s4-mux}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cD}{Custom Combinational Circuit Design}{sub:s4-comb-custom}
...
\phantomsection
\label{sec:S5}
\pdfbookmark[1]{S5: Flip-Flops, Latches \& Race-Around Problems}{sec:S5}
\section*{S5 \quad Flip-Flops, Latches \& Race-Around Problems}
\addsectiontoc{S5: Flip-Flops, Latches \& Race-Around Problems}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{SR Latch \& SR/JK Undefined Condition}{sub:s5-sr}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{JK Flip-Flop Characteristics}{sub:s5-jk}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Master-Slave D Flip-Flop}{sub:s5-master-slave}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Sequential Circuit Timing Analysis}{sub:s5-timing}
...
% Right SR Latch (N5, N6)
\node[american nand port, gate] (N5) at (6, 1.5) {};
\node[american nand port, gate] (N6) at (6, -1.5) {};

% Middle Control Gates (N2, N3)
% Placed such that outputs align perfectly with the inputs of the SR latch
\node[american nand port, gate] (N2) at (0, 1.78) {};
\node[american nand port, gate] (N3) at (0, -1.78) {};

% Input Stage Gates (N1, N4)
\node[american nand port, gate] (N1) at (0, 4.0) {};
\node[american nand port, gate] (N4) at (0, -4.0) {};


% ==========================
% ROUTING: RIGHT SR LATCH (N5 & N6)
% ==========================

% Q and Q' Outputs
\draw[thick] (N5.out) -- (8.5, 1.5) node[right] {$Q$};
\draw[thick] (N6.out) -- (8.5, -1.5) node[right] {$Q'$};

% Q Feedback to N6
\fill (7.2, 1.5) circle (2pt);
\draw[thick] (7.2, 1.5) -- (7.2, 0.2) -- (4.2, 0.2) |- (N6.in 1);

% Q' Feedback to N5
\fill (7.6, -1.5) circle (2pt);
\draw[thick] (7.6, -1.5) -- (7.6, -0.2) -- (4.4, -0.2) |- (N5.in 2);


% ==========================
% ROUTING: MIDDLE TO RIGHT (S & R)
% ==========================

% S Line (N2 out to N5 in)
\draw[thick] (N2.out) -- (N5.in 1) node[midway, above] {$S$};
\fill (1.6, 1.78) circle (2pt); % Connection dot for N2 feedback

% R Line (N3 out to N6 in)
\draw[thick] (N3.out) -- (N6.in 2) node[midway, above] {$R$};
\fill (1.6, -1.78) circle (2pt); % Connection dot for N3 feedback


% ==========================
% ROUTING: N1 & N2 CROSS-COUPLING
% ==========================

% N1 Output to N2 Top Input
\draw[thick] (N1.out) -- (1.2, 4.0) -- (1.2, 2.7) -- (-1.5, 2.7) |- (N2.in 1);

% N2 Output to N1 Bottom Input
\draw[thick] (1.6, 1.78) -- (1.6, 2.9) -- (-1.6, 2.9) |- (N1.in 2);


% ==========================
% ROUTING: N3 & N4 CROSS-COUPLING
% ==========================

% N3 Output to N4 Top Input
\draw[thick] (1.6, -1.78) -- (1.6, -2.9) -- (-1.6, -2.9) |- (N4.in 1);

% N4 Output to N3 Bottom Input (and branching to Global Feedback)
\draw[thick] (N4.out) -- (1.2, -4.0);
\fill (1.2, -4.0) circle (2pt);
\draw[thick] (1.2, -4.0) -- (1.2, -2.7) -- (-1.5, -2.7) |- (N3.in 2);


% ==========================
% ROUTING: GLOBAL FEEDBACK (N4 to N1)
% ==========================

% Outer far-left feedback loop from N4 output to N1 top input
\draw[thick] (1.2, -4.0) -- (1.2, -5.0) -- (-3.5, -5.0) |- (N1.in 1);


% ==========================
% ROUTING: INPUT SIGNALS (Clk & D)
% ==========================

% Clk Input
\draw[thick] (-4.5, 0) node[left] {$Clk$} -- (-2.5, 0);
\fill (-2.5, 0) circle (2pt);
\draw[thick] (-2.5, 0) |- (N2.in 2);
\draw[thick] (-2.5, 0) |- (N3.in 1);

% D Input
\draw[thick] (-4.5, -4.28) node[left] {$D$} -- (N4.in 2);
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Latch vs Flip-Flop}{sub:s5-latch-ff}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cE}{Flip-Flop Conversion}{sub:s5-conversion}
...
\mk{11} \yr{CSE 205 | L-2/T-1 | 2023--24, 2022--23, 2016--17}
...
\phantomsection
\label{sec:S6}
\pdfbookmark[1]{S6: Sequential Circuits, State Diagrams \& FSM}{sec:S6}
\section*{S6 \quad Sequential Circuits, State Diagrams \& FSM}
\addsectiontoc{S6: Sequential Circuits, State Diagrams \& FSM}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{State Diagram Derivation from Circuit}{sub:s6-state-derivation}
...
\end{enumerate}
\mk{20} \yr{CSE 205 | L-2/T-1 | 2021--22, 2019--20}
...
\end{enumerate}
\subtopic{cF}{Circuit Design from State Diagram}{sub:s6-circuit-design}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{Sequence Detector}{sub:s6-sequence}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{Mealy \& Moore Model Comparison \& Block Diagrams}{sub:s6-mealy-moore}
...
\end{enumerate}
%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{State Minimization (Implication Table)}{sub:s6-state-min}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{Incompletely Specified Machine Minimization}{sub:s6-incomp}
...
\item For the incompletely specified machine , complete the implication table and determine the maximal compatibles and maximal incompatibles. Find the upper and lower bounds. Give the state table of the minimal machine.
...
\subtopic{cF}{Redundant States}{sub:s6-redundant}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{Output Assignment in Flow Table}{sub:s6-output-assign}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{Fundamental Mode Design}{sub:s6-fundamental}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{Excitation Function \& Transition Table}{sub:s6-excitation}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{Hazards in Asynchronous Circuits}{sub:s6-hazards}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{Serial Parity Generation}{sub:s6-parity}
...
\mk{10} \yr{CSE 205 | L-2/T-1 | 2020--21, 2018--19}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{Race Around Condition}{sub:s6-race}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{Pulse Mode Logic}{sub:s6-pulse}
...
\phantomsection
\label{sec:S7}
\pdfbookmark[1]{S7: Registers \& Counters}{sec:S7}
\section*{S7 \quad Registers \& Counters}
\addsectiontoc{S7: Registers \& Counters}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cG}{Ripple (Asynchronous) Counter}{sub:s7-ripple}
...
\mk{5} \yr{CSE 205 | L-2/T-1 | 2020--21, 2018--19}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cG}{Synchronous Counter Design}{sub:s7-sync-counter}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cG}{Synchronous Gray Code Counter}{sub:s7-gray}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cG}{Switch-Tail Ring Counter}{sub:s7-ring}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cG}{Johnson Counter vs Ring Counter}{sub:s7-johnson}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cG}{Counter Direction Analysis}{sub:s7-direction}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cG}{Clock Generator / Divider}{sub:s7-clock}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cG}{Universal Shift Register}{sub:s7-universal}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cG}{Serial Adder \& Serial Subtractor}{sub:s7-serial}
...
\mk{10} \yr{CSE 205 | L-2/T-1 | 2017--18, 2016--17}
...
\phantomsection
\label{sec:S8}
\pdfbookmark[1]{S8: Memory \& Programmable Logic}{sec:S8}
\section*{S8 \quad Memory \& Programmable Logic}
\addsectiontoc{S8: Memory \& Programmable Logic}

%%──────────────────────────────────────────────────────────────────────
\subtopic{cH}{ROM Design \& Expansion}{sub:s8-rom}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cH}{PLA Design}{sub:s8-pla}
...
% Color for connection crosses
\colorlet{crosscol}{cyan!80!blue}

% Macro for connection crosses
\def\bluecross#1#2{
    \draw[crosscol, line width=1.2pt] (#1-0.12, #2-0.12) -- (#1+0.12, #2+0.12);
    \draw[crosscol, line width=1.2pt] (#1-0.12, #2+0.12) -- (#1+0.12, #2-0.12);
}

% Macro for input buffers (Dual rail)
\def\PLAinput#1#2#3#4{
    % #1 = y, #2 = true vertical x, #3 = false vertical x, #4 = label
    \node at (-1.5, #1) {$#4$};
    \draw (-1.2, #1) -- (-0.8, #1);
    % Buffer Triangle
    \draw[fill=cyan!10] (-0.8, #1+0.4) -- (-0.8, #1-0.4) -- (0, #1) -- cycle;
    % True output routing
    \draw (0, #1) -- (#2, #1) -- (#2, 0.5);
    % Inversion bubble
    \draw[fill=white] (-0.3, #1+0.25) circle (0.1);
    % Complemented output routing
    \draw (-0.3, #1+0.35) -- (-0.3, #1+0.8) -- (#3, #1+0.8) -- (#3, 0.5);
}

% Macro for AND gates
\def\PLAand#1#2#3{
    % #1 = y, #2 = label inside, #3 = end x for horizontal line
    \draw (0.5, #1) -- (4.5, #1);
    % AND gate body
    \draw[fill=cyan!10] (4.5, #1+0.4) -- (4.5, #1-0.4) -- (5.0, #1-0.4) arc(-90:90:0.4) -- cycle;
    \node at (4.75, #1) {\small #2};
    % Output line
    \draw (5.4, #1) -- (#3, #1);
}

% Macro for OR gates pointing downwards
\def\PLAor#1#2{
    % #1 = x, #2 = y offset (top of gate)
    \draw (#1, 4.5) -- (#1, #2);
    \begin{scope}[shift={(#1,#2)}]
        \draw[fill=cyan!10] (-0.4, 0.2) .. controls (-0.1, 0) and (0.1, 0) .. (0.4, 0.2)
                            .. controls (0.4,-0.2) and (0.1,-0.6) .. (0,-0.8)
                            .. controls (-0.1,-0.6) and (-0.4,-0.2) .. (-0.4, 0.2) -- cycle;
    \end{scope}
}

% Macro for XOR gates pointing right
\def\PLAxor#1#2#3{
    % #1 = x, #2 = y (center), #3 = label
    \begin{scope}[shift={(#1,#2)}]
        % Input stubs (drawn first to clip behind fill)
        \draw (-0.8, 0.2) -- (0, 0.2);
        \draw (-0.8, -0.2) -- (0, -0.2);
        % Detached back curve
        \draw (-0.55, 0.4) .. controls (-0.25, 0.2) and (-0.25, -0.2) .. (-0.55, -0.4);
        % Main gate body
        \draw[fill=cyan!10] (-0.4, 0.4) .. controls (-0.1, 0.2) and (-0.1, -0.2) .. (-0.4, -0.4)
                            .. controls (0.2, -0.4) and (0.6, -0.1) .. (0.8, 0)
                            .. controls (0.6, 0.1) and (0.2, 0.4) .. (-0.4, 0.4) -- cycle;
        % Output wire
        \draw (0.8, 0) -- (1.3, 0) node[right] {$#3$};
    \end{scope}
}

% --- Draw Input Buffers and Vertical Lines ---
% Inputs: y-coord, true-x, false-x, label
\PLAinput{8.5}{3}{3.5}{A}
\PLAinput{7.0}{2}{2.5}{B}
\PLAinput{5.5}{1}{1.5}{C}

% Input Labels at bottom
\node[below] at (1, 0.5) {$C$};
\node[below] at (1.5, 0.5) {$C'$};
\node[below] at (2, 0.5) {$B$};
\node[below] at (2.5, 0.5) {$B'$};
\node[below] at (3, 0.5) {$A$};
\node[below] at (3.5, 0.5) {$A'$};

% --- Draw AND Array ---
\PLAand{4}{1}{7.8} \node[right] at (7.9, 4) {$AB'$};
\PLAand{3}{2}{7.8} \node[right] at (7.9, 3) {$AC$};
\PLAand{2}{3}{7.8} \node[right] at (7.9, 2) {$BC$};
\PLAand{1}{4}{7.8} \node[right] at (7.9, 1) {$A'BC'$};

% AND Array Connections
% AND 1 (AB')
\bluecross{3}{4} \bluecross{2.5}{4}
% AND 2 (AC)
\bluecross{3}{3} \bluecross{1}{3}
% AND 3 (BC)
\bluecross{2}{2} \bluecross{1}{2}
% AND 4 (A'BC')
\bluecross{3.5}{1} \bluecross{2}{1} \bluecross{1.5}{1}
...
% Left OR (to F2)
 \bluecross{6.0}{3} \bluecross{6.0}{2}
% Right OR (to F1)
\bluecross{7.0}{4} \bluecross{7.0}{3} \bluecross{7.0}{1}

% --- Draw 0/1 Selection Array ---
% Horizontal constant lines
\draw (7.5, -0.5) -- (9.0, -0.5) node[right] {0};
\draw (7.5, -1.0) -- (9.0, -1.0) node[right] {1};

% 0/1 Array Connections
\bluecross{8.5}{-0.5} % Right vertical wire connects to 0
\bluecross{8.0}{-1.0} % Left vertical wire connects to 1

% --- Draw XOR Gates ---
\PLAxor{10}{-1.5}{F_1}
\PLAxor{10}{-2.5}{F_2}

% --- Routing to XOR Gates ---
% Right OR to Top XOR (F1) bottom input
\draw (7.0, -0.8) |- (9.2, -1.7);
% Left OR to Bottom XOR (F2) bottom input
\draw (6.0, -0.8) |- (9.2, -2.7);

% Right Vertical Wire (0) to Top XOR (F1) top input
\draw (8.5, -0.2) |- (9.2, -1.3);
% Left Vertical Wire (1) to Bottom XOR (F2) top input
\draw (8.0, -0.2) |- (9.2, -2.3);
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cH}{RAM Design}{sub:s8-ram}
...
%%──────────────────────────────────────────────────────────────────────
\subtopic{cF}{Synchronous Sequential Circuit Design}{sub:s6-sync-design}
