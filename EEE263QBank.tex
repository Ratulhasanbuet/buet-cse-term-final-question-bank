...
\begin{enumerate}\item How can the MOSFET transconductance $g_m$ be varied with the design parameters $W/L$ ratio and overdrive voltage $V_{ov}$? Explain.
\mk{10} \yr{EEE 263 | L-2/T-1 | 2014--15}
...
\begin{enumerate}\item For the Common Source amplifier circuit shown, the transistor has $V_t=1\,\text{V}$, $\mu_n C_{ox}(W/L)=4\,\text{mA/V}^2$, and $V_A=100\,\text{V}$. All capacitors behave as open circuits under DC and short circuits under AC.\\
...
\begin{enumerate}\item Find the expression of output voltage $v_0$ in terms of input voltages and resistances in the circuit shown. Also calculate the value of output voltage at $t=1\,\text{sec}$ given that $v_1=2\,\text{V}$, $v_2=5\,\text{V}$, $v_3=1\,\text{V}$, and $v_4=5\sin(100\pi t)$.
\begin{center}
